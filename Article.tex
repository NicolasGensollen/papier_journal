...
\begin{figure}
\includegraphics[scale=.48]{gaussian_P_star}
...
\begin{figure}
\includegraphics[scale=.48]{mean_field}
...
\begin{figure}
\includegraphics[scale=.48]{cliques_histo}
...
\begin{figure}
\includegraphics[scale=.48]{real_utility_2}
...
\begin{figure}
\includegraphics[scale=.48]{./figures/coalitions/coalitions6}
...
\begin{figure}
\includegraphics[scale=.48]{./figures/resilience_both}
