...
Which leads to the following expression for $ \alpha^{\star} $ (see Appendix) :
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.46]{./figs/figure_3}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.46]{./figs/figure_4}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.46]{./figs/figure_5}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.46]{./figs/figure_6}
