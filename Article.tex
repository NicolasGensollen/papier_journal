...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.35]{figure_1.eps}
		\caption{Process}
		\label{fig:process}
	\end{center}
\end{figure}
...
\noindent where $ P_{i}^{P}(t) $ represents the total production of agent i at time t and $ P_{i}^{D}(t) $ its consumption at time t. In other words, $ P_{i}(t) $ represents the instantaneous surplus of power that agent i is willing to sell at time t. We simulated these traces by considering separately $ P_{i}^{P} $ and $ P_{i}^{D} $. For a prosumer i, it is possible to write both quantities as a sum over the distributed energy resources ($ DER_{i} $) and loads ($ load_{i} $) of i : 
...
\noindent where $ erf $ is the error function : $ erf(x) = \dfrac{2}{\sqrt{\pi}}\int_{0}^{x} e^{-t^{2}} dt $.
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.46]{figure_2.eps}
...
\noindent Which leads to (see Appendix) :
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.46]{figure_3.eps}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.45]{figure_4.eps}
...
\noindent The algorithm takes inputs from :
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.45]{figure_5.eps}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.45]{figure_6.eps}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=.45]{figure_7.eps}
