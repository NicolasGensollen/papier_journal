...
\begin{figure}
\includegraphics[scale=.55]{cliques_histo}
...
\begin{figure}
\includegraphics[scale=.55]{real_utility_2}
...
\begin{figure}
\includegraphics[scale=.55]{search}
...
\begin{figure}
\includegraphics[scale=.55]{./figures/coalitions/coalitions6}
...
\begin{figure}
\includegraphics[scale=.55]{./figures/resilience_both}
